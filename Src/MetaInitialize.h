	...
	void Initialize() {
		{
			...
			DEFINET(actpp, ActingPalette*);
			ADD(actpp);

			DEFINEDCARRAY2(ActingPalette*, actpp);

			DEFINET(actapp, ActingAccentPalette*);
			ADD(actapp);

			DEFINEDCARRAY2(ActingAccentPalette*, actapp);

			DEFINET(actppg, ActingPaletteGroup*);
			ADD(actppg);
