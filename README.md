...
When loading TTARCH2 bundles, MAKE SURE to have 'oo2core_8_win64.dll' is in the same directory as the executable. Preferably this dll should be kept along side this library's DLL.
